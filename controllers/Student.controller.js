...
exports.create = (req, res) => {
    ...
    const student = new Student({
            ...
            RegisteredWithUs: req.body.RegisteredWithUs
    });
...
//                 message: "student not found with id " + req.params.userId
//             });            
//         }
//         res.send(student);
//     }).catch(err => {
...
exports.delete = (req, res) => {
    ...
    .then(student => {
        ...
        return res.status(500).send({
            message: "Could not delete user with id " + req.params.studentId
        });
    });
